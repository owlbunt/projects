...
function loadUserDetails(userDetails) {
    ...
    let profileIcons = document.querySelectorAll(".profileIcon");
    for(let i = 0 ;i < profileIcons.length; i ++ ){
        let profileIcon = profileIcons[i];
        profileIcon.src = profileImg;   
    }
    document.querySelector(".profileName").textContent = userFullName;
    document.querySelector(".profileUsername").innerHTML = userData.Username;
}
            ...
            <div class="messageTemplate">
                ...
                <div class="d-flex align-items-center">
                    ...
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu border-0 text-small shadow-lg" style="transform-origin: top;">
